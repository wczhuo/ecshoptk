...
return  array(
    ...
    'TMPL_TEMPLATE_SUFFIX'  =>  '.dwt',     // 默认模板文件后缀
    ...
    'TMPL_ENGINE_CONFIG' => array(
        ...
        /*
          * $phpyun->force_compile  = true; //强迫编译
...
//$phpyun->cache_dir      = DATA_PATH.'/cache/';
        ...
        'left_delimiter'=>'<!--{',
        'right_delimiter' =>'}-->',
        'left_delimiter_list' => array('<!--{','<!-- {','{yun:}','{wcz:}','{xyy:}'),
        'right_delimiter_list'=> array('}-->','} -->','{/yun}','{/wcz}','{/xyy}')
     ),
